  ...
  return (
    <div className="flex flex-col min-h-screen h-full">
      <div className="flex flex-1 flex-col mx-5 lg:mx-20 p-20">
        <h1 className="font-bold text-4xl mb-5">Código de Conduta</h1>
        <h2 className="font-bold text-3xl mb-2">Nosso Compromisso</h2>
        ...
        <h2 className="font-bold text-3xl mb-2">Nossos Valores</h2>
        <p className="text-lg break-normal mb-5">
        ...
        <h2 className="font-bold text-3xl mb-2">Nossas Responsabilidades</h2>
        <p className="text-lg break-normal mb-5">
        ...
        <h2 className="font-bold text-3xl mb-2">Execução</h2>
        <p className="text-lg break-normal mb-5">
        ...
        <h2 className="font-bold text-3xl mb-2">Atribuição</h2>
        <p className="text-lg">
