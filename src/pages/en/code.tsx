  ...
  return (
    <div className="flex flex-col min-h-screen h-full">
      <div className="flex flex-1 flex-col mx-5 lg:mx-20 p-20">
        <h1 className="font-bold text-4xl mb-5">Code of Conduct</h1>
        <h2 className="font-bold text-3xl mb-2">Our Pledge</h2>
        ...
        <h2 className="font-bold text-3xl mb-2">Our Standards</h2>
        <p className="text-lg break-normal mb-5">
        ...
        <h2 className="font-bold text-3xl mb-2">Our Responsibilities</h2>
        <p className="text-lg break-normal mb-5">
        ...
        <h2 className="font-bold text-3xl mb-2">Scope</h2>
        <p className="text-lg break-normal mb-5">
        ...
        <h2 className="font-bold text-3xl mb-2">Enforcement</h2>
        <p className="text-lg break-normal mb-5">
        ...
        <h2 className="font-bold text-3xl mb-2">Attribution</h2>
        <p className="text-lg">
