  ...
  return (
    <div className="flex flex-col h-full min-h-screen bg-primary">
      ...
      <div className="flex flex-col flex-1 pb-20 mx-5 md:mx-20">
        <h1 className="mb-5 bold-36">Privacy Policy</h1>
        <p className="mb-5 break-normal regular-18">
          cobogo operates the https://cobogo.social website, which provides the
          dApp Service.
        </p>
        <p className="mb-5 break-normal regular-18">
          This page is used to inform website visitors of our policies regarding
          the collection, use, and disclosure of Personal Information of anyone
          who decides to use our Service, the cobogo social dApp and website.
        </p>
        <p className="mb-5 break-normal regular-18">
        ...
        <h2 className="mb-2 bold-30">Information Collection and Use</h2>
        <p className="mb-5 break-normal regular-18">
        ...
        <h2 className="mb-2 bold-30">Log Data</h2>
        <p className="mb-5 break-normal regular-18">
          ...
          Protocol (&quot;IP&quot;) address, browser version, pages you visited
          in our Service, the time and date of your visit, the time spent on
        ...
        <p className="mb-5 break-normal regular-18">
          ...
          the website you visit and are stored on your computer’s hard drive.
        </p>
        <p className="mb-5 break-normal regular-18">
          ...
          cookies, and to know when a cookie is being sent to your computer. If
          you choose to refuse our cookies, you may not be able to use some
          portions of our Service.
        </p>
        <h2 className="mb-2 bold-30">Service Providers</h2>
        <p className="mb-5 break-normal regular-18">
        ...
        <p className="mb-5 break-normal regular-18">
          ...
          access to your Personal Information, so they can perform the tasks
          assigned to them on our behalf. However, they are obligated not to
          disclose or use the information for any other purpose.
        </p>
        <h2 className="mb-2 bold-30">Security</h2>
        <p className="mb-5 break-normal regular-18">
          We value your trust in providing us your Personal Information, thus we
          strive to use commercially acceptable means of protecting it. Note
          that no method of transmission over the internet, or method of
          electronic storage is 100% secure and reliable, and we cannot
          guarantee its absolute security.
        </p>
        <h2 className="mb-2 bold-30">Links to Other Sites</h2>
        <p className="mb-5 break-normal regular-18">
        ...
        <p className="mb-2 bold-30">Children&apos;s Privacy</p>
        <p className="mb-5 break-normal regular-18">
        ...
        <h2 className="mb-2 bold-30">Changes to This Privacy Policy</h2>
        <p className="mb-5 break-normal regular-18">
        ...
        <h2 className="mb-2 bold-30">Contact Us</h2>
        <p className="mb-5 break-normal regular-18">
