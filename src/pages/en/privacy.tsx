  ...
  return (
    <div className="flex flex-col h-full min-h-screen">
      <div className="flex flex-col flex-1 p-20 mx-5 lg:mx-20">
        ...
        <h2 className="mb-2 font-bold text-3xl">Log Data</h2>
        <p className="mb-5 break-normal regular-18">
        ...
        <h2 className="mb-2 font-bold text-3xl">Service Providers</h2>
        <p className="mb-5 break-normal regular-18">
        ...
        <h2 className="mb-2 font-bold text-3xl">Security</h2>
        <p className="mb-5 break-normal regular-18">
        ...
        <h2 className="mb-2 font-bold text-3xl">Links to Other Sites</h2>
        <p className="mb-5 break-normal regular-18">
        ...
        <p className="mb-2 font-bold text-3xl">Children&apos;s Privacy</p>
        <p className="mb-5 break-normal regular-18">
        ...
        <h2 className="mb-2 font-bold text-3xl">Contact Us</h2>
        <p className="mb-5 break-normal regular-18">
