  ...
  return (
    <div className="scale-50 lg:scale-100 absolute top-8 lg:top-16 left-1/2 -translate-x-1/2 z-10">
      ...
      <div className="h-[220px] w-[260px] flex items-center justify-between clip-path-polygon-[0_0,_100%_45%,_100%_55%,_0_100%] relative">
        <button
          className="w-[130px] h-full rounded-none bg-white/10 focus:bg-yellow-community transition-colors"
          onClick={() => props.setSelectedProduct('community')}
        />

        <button
          className="w-[60px] h-full rounded-none bg-white/10 focus:bg-blue-social transition-colors"
          onClick={() => props.setSelectedProduct('social')}
        />

        <button
          className="w-[70px] h-full rounded-none bg-white/10 focus:bg-pink-launchpad transition-colors"
